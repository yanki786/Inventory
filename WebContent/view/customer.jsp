...
<jsp:useBean id="tempp" scope="request" class="com.web.entity.Product" />
<%
	int ix = -1;
...
<%
	List<Person> customers = ubx.getCustomers();
...
<c:if test='<%=request.getMethod().equals("POST")%>'>
	...
	<c:choose>
		<c:when test='<%=request.getParameter("btn").equals("Submit")%>'>
			<%
				ubx.addPerson(temp, Person.Type.CUSTOMER);
			%>
		</c:when>
		...
		<c:when test='<%=request.getParameter("btn").equals("Update")%>'>
			...
			ubx.updatePerson(temp, Person.Type.CUSTOMER);
			%>
		</c:when>
		...
		<c:when test='<%=request.getParameter("btn").equals("Sell")%>'>
			<%
								...
								<div
									...
									<div class="u-container-layout u-container-layout-2">
										<a href="#sec-03df"
											...
											customer </a> <a href="#sec-04df"
											class="u-btn u-button-style u-dialog-link u-gradient u-none u-text-body-alt-color u-btn-1">sell
											product </a>
											...
											<table class="u-table-entity u-table-entity-1">
												...
												<tbody class="u-table-body">
													...
													<tr class="u-table-row-hover clickable-row"
														...
														<td class="u-table-cell">cid <%=customers.get(i).getId()%></td>
									...
									<div class="u-expanded-width u-form u-form-1">
										<form action="#" method="POST"
											...
											<div class="u-form-group u-form-select u-form-group-1">
												<label for="select-bc1c" class="u-label">Customer id</label>
											...
											<div
												...
												<input
													class="u-btn u-btn-submit u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-1"
													type="submit" value="Sell" name="btn">
											</div>
										</form>
									</div>
								</div>
